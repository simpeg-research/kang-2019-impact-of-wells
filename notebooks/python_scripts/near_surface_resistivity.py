...
result_dir = "../near_surface_resistivity/"
...
layer_thickness = 4
# resistivity_near = 1000.
# resistivity_nears = [5, 20, 80, 320, 1280]
resistivity_nears = [1, 5, 20, 100, 340, 1000]
for i_res, resistivity_near in enumerate(resistivity_nears):
